...
public interface DBConnection {
	 ...
	 * @param itemIds
	 */
	public void setFavoriteItem(String userId, String itemId);
	 ...
	 */
	public Set<Item> getFavoriteItems(String userId) throws ParseException;
	
	/**
	 * Get the favorite itemIds for a user.
	 * 
	 * @param userId
	 * @return itemIds
	 */
	...
	/**
	 * Save registration info into db.
	 * 
	 * @param item
	 */
